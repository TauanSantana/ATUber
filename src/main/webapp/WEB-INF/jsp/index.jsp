...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <!-- Login Form -->
        <form action="/login" method="post" style="margin-top: 7%;">
        ...
        <!-- Remind Passowrd -->
        <div id="formFooter">
            <a class="underlineHover" href="login/CadastroSolicitante">Cadastre-se</a>
            <a class="underlineHover" href="#" style="margin-left: 46%;">Esqueci minha senha</a>
        </div>
